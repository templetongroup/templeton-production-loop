...
description: Read-only status of Templeton coding-loop queues across GitHub issues and pull requests, returning the human owner's exact approve, answer, review, or merge actions.
version: 0.2.0
license: MIT
---

# Templeton Loop — Status for OpenClaw
...
Return exact URLs and one-line actions. Re-read GitHub; do not rely on chat, A2A messages, or cached state. Never merge, label, assign, comment, or start a worker from this skill.
